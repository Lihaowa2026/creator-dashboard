...
const plans = [
  ...
  },
  {
    ...
    category: "口服美容",
    time: "2026-07-26",
    summary: "肤色暗黄痛点+旧照片对比+内服美白+冲泡展示+口感好喝",
    shots: [
      "前3秒产品前置：手举冲好饮料怼镜头",
      "素颜展示肤色暗沉不均",
      "翻手机旧照片对比以前白现在黄",
    ...
    script: [
      { shot: "前3秒·产品前置", text: "就这个，喝了一个月，我朋友问我是不是偷偷去打了美白针。", film: "手举冲好的粉橙色饮料怼镜头", shoot: "云台正面中景，补光正前方" },
      { shot: "痛点1", text: "你们看我这张脸，之前又黄又暗，素颜根本不敢出门，拍照全靠滤镜撑。", film: "素颜怼镜头，展示肤色暗沉", shoot: "云台正面近景，补光正前方，不美颜" },
      { shot: "放大焦虑", text: "翻以前照片更明显，我以前挺白的，不知道什么时候开始就越来越黄，像没睡醒一样。", film: "手翻手机旧照片，对比以前白现在黄", shoot: "云台侧面近景，拍手机屏幕+手指" },
      { shot: "排除其他方案", text: "精华涂了，面膜敷了，防晒也没少涂，该黄还是黄，钱花了一堆没见白。", film: "快闪精华瓶、面膜、防晒霜3个空镜，1秒1个", shoot: "云台固定拍桌面，3个快切" },
      { shot: "认知反转", text: "后来才知道，外涂的东西到不了底层，想真白得从里面调。", film: "手指脸颊，画面加字幕内服才管用", shoot: "云台正面近景，补光正前方" },
      { shot: "产品介绍", text: "就是这个，芙山飘恋白番茄血橙饮料，里面有白番茄、血橙、烟酰胺、维C维E，都是美白抗氧化的东西。", film: "手拿包装盒怼镜头，手指指成分表", shoot: "云台正面中景，手拿包装" },
      { shot: "冲泡展示", text: "冲泡特别简单，撕开倒杯子里，温水一搅就化了，颜色是那种粉粉橙橙的，看着就想喝。", film: "撕包装→倒粉→加水搅拌过程", shoot: "云台近景固定拍桌面操作" },
      { shot: "口感", text: "重点是真好喝，酸酸甜甜的血橙味，不像有的冲剂喝着像药，这个我每天主动想喝。", film: "喝一口，表情享受，舔嘴唇", shoot: "云台正面近景，补光柔光" },
      { shot: "产品空镜(无文案)", text: "（无文案·产品完整空镜）", film: "包装盒+条包摆桌面，云台缓推", shoot: "云台近景缓推，干净背景，5秒" },
      { shot: "日常场景", text: "我一般早上起来空腹喝一杯，或者出门前撕一包带着，温水冲一下就能喝，特别方便。", film: "办公桌冲泡/出门前拿一包放包里", shoot: "云台中景拍日常场景" },
      { shot: "效果", text: "喝了大概一个月，最明显的感觉是脸没那么黄了，透亮了一些，同事问我是不是换了粉底。", film: "手指脸颊，展示皮肤光泽状态", shoot: "云台正面近景，补光亮，皮肤有光泽" },
      { shot: "促单收尾", text: "想白的姐妹别光往外脸上涂了，试试从里面调，这个真比我涂那些瓶瓶罐罐管用。", film: "手拿饮料+包装盒对着镜头", shoot: "云台正面中景，举产品，真诚语气" },
    ],
  },
  {
    id: "zuodian-sleep",
